    ...
    () => [
      ...
      // Create A Election Managment System
      {
        ...
        items: [
          // USER
          {
            title: t('Canditate Registration'),
            path: paths.dashboard.user.root,
            icon: ICONS.user,
            children: [
              // { title: t('profile'), path: paths.dashboard.user.root },
              // { title: t('cards'), path: paths.dashboard.user.cards },
              { title: t('Add'), path: paths.dashboard.user.list },
              { title: t('Show Canditates List'), path: paths.dashboard.user.new },
              // { title: t('edit'), path: paths.dashboard.user.demo.edit },
              // { title: t('Delete'), path: paths.dashboard.user.account },
            ],
          },
          ...
          // PRODUCT
          {
            ...
            icon: ICONS.product,
            children: [
              { title: t('Add Voter'), path: paths.dashboard.product.root },
              {
          ...
          // ORDER
          {
            ...
            icon: ICONS.order,
            children: [
              { title: t('Add Election'), path: paths.dashboard.order.root },
              { title: t('Show Election List'), path: paths.dashboard.order.demo.details },
            ],
          },
          ...
          // INVOICE
          {
            ...
            icon: ICONS.invoice,
            children: [
              { title: t('Add Ward'), path: paths.dashboard.invoice.root },
              {
                title: t('Show Ward List'),
                path: paths.dashboard.invoice.demo.details,
              },
              // { title: t('create'), path: paths.dashboard.invoice.new },
              // { title: t('edit'), path: paths.dashboard.invoice.demo.edit },
          ...
          // BLOG
          {
            title: t('Booth Canditate'),
            path: paths.dashboard.post.root,
            icon: ICONS.blog,
            children: [
              { title: t('Add Booth'), path: paths.dashboard.post.root },
              { title: t('Show Booth List'), path: paths.dashboard.post.demo.details },
              // { title: t('create'), path: paths.dashboard.post.new },
              // { title: t('edit'), path: paths.dashboard.post.demo.edit },
            ],
          },
